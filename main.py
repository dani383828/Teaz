...
UPDATE subscriptions SET start_date = COALESCE(start_date, CURRENT_TIMESTAMP),
                        duration_days = CASE
                            ...
                            WHEN plan = '🥈۳ ماهه | ۲۱۰,۰۰۰ تومان | نامحدود' THEN 90
                            WHEN plan = '🥇۶ ماهه | ۳۸۰,۰۰۰ تومان | نامحدود' THEN 180
...
def get_subscription_keyboard(is_agent=False):
    if is_agent:
        keyboard = [
            ...
            [KeyboardButton("🥈۳ ماهه | ۲۱۰,۰۰۰ تومان | نامحدود")],
            [KeyboardButton("🥇۶ ماهه | ۳۸۰,۰۰۰ تومان | نامحدود")],
...
async def add_subscription(user_id, payment_id, plan):
    try:
        duration_mapping = {
            ...
            "🥈۳ ماهه | ۲۱۰,۰۰۰ تومان | نامحدود": 90,
            "🥇۶ ماهه | ۳۸۰,۰۰۰ تومان | نامحدود": 180
        }
...
async def message_handler(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    if text in [
        ...
        "🥉۱ ماهه | ۷۰,۰۰۰ تومان | نامحدود", "🥈۳ ماهه | ۲۱۰,۰۰۰ تومان | نامحدود", "🥇۶ ماهه | ۳۸۰,۰۰۰ تومان | نامحدود"
    ]:
        mapping = {
            ...
            "🥈۳ ماهه | ۲۱۰,۰۰۰ تومان | نامحدود": (210000, 1),
            "🥇۶ ماهه | ۳۸۰,۰۰۰ تومان | نامحدود": (380000, 2)
        }
    ...
    if text == "🧑‍💼 درخواست نمایندگی":
        ...
        agency_text = (
            ...
            "🥈 سه ماهه | ۲۱۰,۰۰۰ تومان | نامحدود (٪۱۶ کاهش)\n"
            "🥇 شش ماهه | ۳۸۰,۰۰۰ تومان | نامحدود (٪۱۶ کاهش)\n\n"
